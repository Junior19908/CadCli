    ...
    public partial class CadastroClientes : MetroFramework.Forms.MetroForm
    {
        public CadastroClientes()
        {
            ...
            try
            {
                if (ClassConexao.DBSCV().State == ConnectionState.Open)
                {
                    ...
                    OleDbCommand cmdSelect = new OleDbCommand("SELECT * FROM TB_ArquivoDBSCV ORDER BY col_id ASC");
                    cmdSelect.Connection = ClassConexao.DBSCV();
                    OleDbDataReader oleDbData = cmdSelect.ExecuteReader();
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "INSERT INTO TB_ClienteDBSCV (col_nomeCompleto,col_Cpf,col_rg,col_cnpj,col_inscricao,col_celular1,col_celular2,col_endereco,col_estado,col_cidade,col_bairro,col_cep,col_numero,col_complemento,col_site,col_email,col_info,col_dataCadastro,col_usuarioCadastro) VALUES" +
                    ...
                    ",'" + txtSite.Text + "','" + txtemail.Text + "','" + txtInfo.Text + "', NOW(), '"+ ClassDadosGEt.IDUsuario +"')";
